splitFastQNovogene <- function( reads1, reads2, primerF, primerR, outfile_R1, outfile_R2, ind_f, ind_r, max_mismatch ){ # reads1 and reads2 ShortReadQ objects for paired fastq files (order of reads must be the same in both objects) obtained with readFastq of ShortRead
