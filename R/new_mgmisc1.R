...
new_mg <- function(){
  ...
  palette="nrc_npg"
  metadata <- list(creation.date, modification.date, basename, marker.seq, description, rand.seed, working.dir, classification.db, mothur, mothur.version, pairwise.alignment, reference.alignment, PICRUSt2, PICRUSt2.version, palette.family, palette)
